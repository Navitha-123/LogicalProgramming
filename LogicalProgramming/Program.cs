namespace LogicalProgramming
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("choose option 1.Fibonacci \t 2.PerfectNumber \t 3.Primenumber \t 4.Reversenumber \t 5. Dayofweek \t 6.Temperature \t 7.MonthlyPayment \t 8.Squareroot  \t 9. Binaryvalue \t 10.BinarySwap \t 11.Coupnnumber");
